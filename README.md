...
- **Self-signed HTTPS:** Integrated self-signed certificate management for internal homelab services (Pi-hole, Immich, Prometheus, Uptime Kuma) to enhance local network security.
