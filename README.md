...
- **Self-signed HTTPS:** Integrated self-signed certificate management for internal homelab services (Pi-hole, Immich, Prometheus, Grafana, Uptime Kuma) to enhance local network security.
