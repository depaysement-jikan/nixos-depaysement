{
  ...
  sops = {
    age = {
      ...
      # sudo sops --encrypt  --in-place --age $(sudo age-keygen -y /var/lib/sops-nix/age/key.txt) "/home/depaysement/.nixos-dotfiles/hosts/shinobu"/hosts/shinobu/users/kokoro/secrets.yaml
